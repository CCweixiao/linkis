...
public class AMConfiguration {
  ...
  public static final CommonVars<String> MULTI_USER_ENGINE_TYPES =
      CommonVars.apply(
          "wds.linkis.multi.user.engine.types", "jdbc,es,presto,io_file,appconn,openlookeng,trino,hbase");
  ...
  public static String getDefaultMultiEngineUser() {
    ...
    return String.format(
        "{jdbc:\"%s\", es: \"%s\", presto:\"%s\", appconn:\"%s\", openlookeng:\"%s\", trino:\"%s\", trino:\"%s\", io_file:\"root\"}",
