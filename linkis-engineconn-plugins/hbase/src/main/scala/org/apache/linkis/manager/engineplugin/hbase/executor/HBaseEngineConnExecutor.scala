...
import org.apache.linkis.manager.engineplugin.hbase.shell.{HBaseShellSession, HBaseShellSessionManager, Result}
...
class HBaseEngineConnExecutor(val id: Int) extends ConcurrentComputationExecutor {
  ...
  private def getHBaseRuntimeParams(engineExecutorContext: EngineExecutionContext): util.Map[String, String] = {
  ...
  override def executeCompletely(engineExecutorContext: EngineExecutionContext,
                                 code: String, completedLine: String): ExecuteResponse = null
